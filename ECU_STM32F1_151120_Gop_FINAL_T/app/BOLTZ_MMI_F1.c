  ...
  while(TRUE){
    ...
    if (f_mount(&FatFs, "", 1) == FR_OK) {                                       // If mounting the SD card was executed correctly
      ...
      if ((res) == FR_OK) {                                                      // test if file is functioning correctly
        ...
        f_printf(&fil, "%s", LCDParam.TBattLVA_str);             f_puts(";", &fil);
        f_printf(&fil, "%s", LCDParam.BattHigh_vol);             f_puts(";", &fil);
        f_printf(&fil, "%s", LCDParam.TBattHVA_str);             f_puts(";", &fil);
        f_printf(&fil, "%s", LCDParam.TBattLow_str);             f_puts("\n", &fil);
...
//    print_string("\033[11;13H"); 
    ...
    print_string("\033[7;50H"); print_string( LCDParam.TBattLVA_str);       
    print_string("\033[7;56H"); print_string( LCDParam.BattHigh_vol);        
    print_string("\033[7;62H"); print_string( LCDParam.TBattHVA_str);    
    print_string("\033[7;68H"); print_string( LCDParam.TBattLow_str);       
